...
const JobPopupMenuItem = new Lang.Class({
    ...
    _init: function(menu, job, notification_source, settings, httpSession, params) {
    	this.parent(params);
		...
		this.event_build = this.button_build.connect("clicked", Lang.bind(this, function(){
        ...
        this.event_showjob = this.connect("activate", Lang.bind(this, function(){
	...
	destroy: function() {
		this.button_build.disconnect(this.event_build);
		this.disconnect(this.event_showjob);
