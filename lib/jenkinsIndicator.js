...
const JenkinsIndicator = new Lang.Class({
    ...
    _init: function(settings, httpSession) {
		...
		this.event_settings = this._menu_settings.connect("activate", function(){
        ...
        this.event_menu = this.actor.connect("button-press-event", Lang.bind(this, this.request));
	...
	destroy: function() {
		// destroy events
		this.disconnect(this.event_settings);
		this.disconnect(this.event_menu);
